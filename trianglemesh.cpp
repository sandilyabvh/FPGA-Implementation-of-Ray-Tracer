    ...
    bool &hit, fixed_t &tnear, fixed_t uv[2], uint32_t &index)
{
    ...
    // {
        ...
        hit = trace(orig, dir, P1, P2, P3, tnear, index, uv,
            ...
            v0Arr, v1Arr, v2Arr);
        // {
        //     getHitColor(orig, dir, tnear, uv, index, texCoordinates,
        //         v0Arr_intersect, v1Arr_intersect, v2Arr_intersect,
        //         hitColor);
        // }
    // }
...
#pragma HLS array_partition variable=v2Arr_intersect_3 dim=0 complete
    ...
    copy3(backgroundColor_DRAM, return_1);
    copy3(return_1, return_2);
    copy3(return_1, return_3);
    ...
    // fixed_t return_1[3], return_2[3], return_3[3];
    ...
    {
        WIDTH_LOOP: for (uint32_t i = 0; i < WIDTH+1; i += 3)
        {
            dataflow(
