...
set Library     "hls"
set IPName      "rayTriangleIntersect"
set Version     "1.0"
set DisplayName "Raytriangleintersect"
set Revision    "2105021825"
...
set xo_kernel_name "rayTriangleIntersect"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/nethome/sbn6/fpga/Lab3B/Lab3B_Vitis/solution1"
set debug_dir "/nethome/sbn6/fpga/Lab3B/Lab3B_Vitis/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {rayTriangleIntersect_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "rayTriangleIntersect"
set TopNoPrefix "rayTriangleIntersect"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 dir_DRAM_1 W 0x0 "Data signal of dir_DRAM" {{0 32 dir_DRAM W 0 "Bit 31 to 0 of dir_DRAM"}}} {0x14 dir_DRAM_2 W 0x0 "Data signal of dir_DRAM" {{0 32 dir_DRAM W 0 "Bit 63 to 32 of dir_DRAM"}}} {0x1c P1_DRAM_offset_1 W 0x0 "Data signal of P1_DRAM_offset" {{0 32 P1_DRAM_offset W 0 "Bit 31 to 0 of P1_DRAM_offset"}}} {0x20 P1_DRAM_offset_2 W 0x0 "Data signal of P1_DRAM_offset" {{0 32 P1_DRAM_offset W 0 "Bit 63 to 32 of P1_DRAM_offset"}}} {0x28 P2_DRAM_offset_1 W 0x0 "Data signal of P2_DRAM_offset" {{0 32 P2_DRAM_offset W 0 "Bit 31 to 0 of P2_DRAM_offset"}}} {0x2c P2_DRAM_offset_2 W 0x0 "Data signal of P2_DRAM_offset" {{0 32 P2_DRAM_offset W 0 "Bit 63 to 32 of P2_DRAM_offset"}}} {0x34 P3_DRAM_offset_1 W 0x0 "Data signal of P3_DRAM_offset" {{0 32 P3_DRAM_offset W 0 "Bit 31 to 0 of P3_DRAM_offset"}}} {0x38 P3_DRAM_offset_2 W 0x0 "Data signal of P3_DRAM_offset" {{0 32 P3_DRAM_offset W 0 "Bit 63 to 32 of P3_DRAM_offset"}}} {0x40 intersectIndex_offset_1 W 0x0 "Data signal of intersectIndex_offset" {{0 32 intersectIndex_offset W 0 "Bit 31 to 0 of intersectIndex_offset"}}} {0x44 intersectIndex_offset_2 W 0x0 "Data signal of intersectIndex_offset" {{0 32 intersectIndex_offset W 0 "Bit 63 to 32 of intersectIndex_offset"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_dir m_axi_P1_DRAM m_axi_P2_DRAM m_axi_P3_DRAM m_axi_intersectIndex"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_dir {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_dir"
        data_width "32"
        param_prefix "C_M_AXI_DIR"
    ...
    m_axi_P1_DRAM {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_P1_DRAM"
        data_width "32"
        param_prefix "C_M_AXI_P1_DRAM"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_P2_DRAM {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_P2_DRAM"
        data_width "32"
        param_prefix "C_M_AXI_P2_DRAM"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_P3_DRAM {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_P3_DRAM"
        data_width "32"
        param_prefix "C_M_AXI_P3_DRAM"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_intersectIndex {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_intersectIndex"
        data_width "32"
        param_prefix "C_M_AXI_INTERSECTINDEX"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 25344 II x}
...
source -notrace "/tools/software/xilinx/Vitis_HLS/2021.1/common/scripts/ipxhls.tcl"
