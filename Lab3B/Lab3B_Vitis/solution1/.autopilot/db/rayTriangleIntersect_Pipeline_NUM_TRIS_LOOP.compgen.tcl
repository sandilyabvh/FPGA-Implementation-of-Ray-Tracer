...
set name rayTriangleIntersect_mul_32s_32s_48_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name rayTriangleIntersect_sdiv_34ns_32s_32_38_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename P2_V_0 \
    op interface \
    ports { P2_V_0_address0 { O 13 vector } P2_V_0_ce0 { O 1 bit } P2_V_0_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename P1_V_0 \
    op interface \
    ports { P1_V_0_address0 { O 13 vector } P1_V_0_ce0 { O 1 bit } P1_V_0_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename P2_V_1 \
    op interface \
    ports { P2_V_1_address0 { O 13 vector } P2_V_1_ce0 { O 1 bit } P2_V_1_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename P1_V_1 \
    op interface \
    ports { P1_V_1_address0 { O 13 vector } P1_V_1_ce0 { O 1 bit } P1_V_1_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename P2_V_2 \
    op interface \
    ports { P2_V_2_address0 { O 13 vector } P2_V_2_ce0 { O 1 bit } P2_V_2_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename P1_V_2 \
    op interface \
    ports { P1_V_2_address0 { O 13 vector } P1_V_2_ce0 { O 1 bit } P1_V_2_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename P3_V_0 \
    op interface \
    ports { P3_V_0_address0 { O 13 vector } P3_V_0_ce0 { O 1 bit } P3_V_0_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename P3_V_1 \
    op interface \
    ports { P3_V_1_address0 { O 13 vector } P3_V_1_ce0 { O 1 bit } P3_V_1_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename P3_V_2 \
    op interface \
    ports { P3_V_2_address0 { O 13 vector } P3_V_2_ce0 { O 1 bit } P3_V_2_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 52 \
    name dir_V_1_068_cast \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_dir_V_1_068_cast \
    op interface \
    ports { dir_V_1_068_cast { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 53 \
    name dir_V_21_069_cast \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_dir_V_21_069_cast \
    op interface \
    ports { dir_V_21_069_cast { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 63 \
    name intersectIndex_BRAM_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_intersectIndex_BRAM_out \
    op interface \
    ports { intersectIndex_BRAM_out { O 16 vector } intersectIndex_BRAM_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_t_V_out \
    op interface \
    ports { t_V_out { O 32 vector } t_V_out_ap_vld { O 1 bit } } \
} "
}
